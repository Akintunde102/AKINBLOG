...
<div id="wrapper">
	...
	<form action='' method='post'>
		...
		<textarea name='postDesc' cols='80' rows='3'><?php if(isset($error)){ echo $_POST['postDesc'];}?></textarea></p>

		<p><label>Content</label><br />
		<textarea id="editor" name='postCont' cols='60' rows='20'><?php if(isset($error)){ echo $_POST['postCont'];}?></textarea></p>
